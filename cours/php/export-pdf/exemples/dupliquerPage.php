...
$pdf->setHeaderData(PDF_HEADER_LOGO, PDF_HEADER_LOGO_WIDTH, 'DUPLIQUER UNE PAGE', '', array(0,64,255), array(187,11,11));
...
$pdf->AddPage();
$pdf->Text(20,20,"Page 1");

$pdf->AddPage();
$pdf->Text(20,20,"Page 2");
...
$pdf->Output('export/dupliquerPage.pdf', 'I');